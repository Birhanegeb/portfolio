export const profile = {
  ...
  summary:
    ...
    "end-to-end pipelines — from raw ingestion through validation to " +
    "analysis-ready data — using Python, SQL, Apache Airflow, Apache Spark, " +
    "Docker, PostgreSQL, and Terraform. Comfortable across the full stack: " +
    "ETL/ELT design, machine learning for data analytics, and backend " +
    "software engineering with REST APIs (Flask, FastAPI, PHP/Lumen).",
}
